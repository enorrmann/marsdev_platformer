...
void updateCamera() {
	...
	cameraPosition.x = clamp(cameraPosition.x, 0, MAP_WIDTH_PX - 320); // 768 - 320 = 448 (level width - screen width)
	cameraPosition.y = clamp(cameraPosition.y, 0, MAP_HEIGHT_PX - 224 ); // 768 - 224 = 544 (level height - screen height)
